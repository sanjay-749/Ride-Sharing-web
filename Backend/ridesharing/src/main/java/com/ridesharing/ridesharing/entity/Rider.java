...
@Entity
@Table(name = "driver_rides") // separate table to avoid colliding with frontend "rides" table
public class Rider {
    ...
    public Rider(String origin, String destination, String status, LocalDateTime rideTime,
